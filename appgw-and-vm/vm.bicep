  ...
  properties: {
    ...
    source: {
      script: '''
        ...
        Invoke-WebRequest "https://nodejs.org/dist/v22.12.0/node-v22.12.0-x64.msi" -OutFile node.msi
        .\node.msi /quiet
        Invoke-WebRequest "https://curl.se/windows/dl-8.11.1_2/curl-8.11.1_2-win64-mingw.zip" -OutFile curl.zip
